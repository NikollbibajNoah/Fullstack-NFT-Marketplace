...
contract NFTMarketplace is ERC721URIStorage {
    ...
    uint256 listingPrice = .0015 ether;
    ...
    modifier onlyOwner() {
        ...
        _; // This allows the function to continue executing after the check
    }
    ...
    // Let create a new NFT Token function
    ...
    function fetchMarketItems() public view returns (MarketItem[] memory) {
        uint256 itemCount = _tokenIds.current(); // Get count of all NFTs
    ...
    function fetchMyNFT() public view returns (MarketItem[] memory) {
        uint256 totalItemCount = _tokenIds.current(); // Get count of all NFTs
        uint256 itemCount = 0;
        uint256 currentIndex = 0;
